class Admin::CompaniesController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.json { render json: Admin::CompaniesDatatable.new(params)}
    end
  end
  ...
  private
    ...
    def admin_company_params
      params.require(:admin_company).permit(:name, :description, :legal_status, :address, :domain_id, :status, :exist_since)
    end
end
