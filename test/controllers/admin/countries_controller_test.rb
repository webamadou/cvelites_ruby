...
class Admin::CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_country" do
    assert_difference('Admin::Country.count') do
      post admin_countries_url, params: { admin_country: { iso: @admin_country.iso, iso3: @admin_country.iso3, libelle: @admin_country.libelle, nicename: @admin_country.nicename, numcode: @admin_country.numcode, phonecode: @admin_country.phonecode, status: @admin_country.status } }
    end
  ...
  test "should update admin_country" do
    patch admin_country_url(@admin_country), params: { admin_country: { iso: @admin_country.iso, iso3: @admin_country.iso3, libelle: @admin_country.libelle, nicename: @admin_country.nicename, numcode: @admin_country.numcode, phonecode: @admin_country.phonecode, status: @admin_country.status } }
